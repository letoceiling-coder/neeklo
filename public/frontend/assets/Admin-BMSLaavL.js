...
`,h=[{id:"overview",title:"Обзор проекта",icon:d},{id:"design",title:"Дизайн-система",icon:l},{id:"structure",title:"Структура",icon:x},{id:"components",title:"Компоненты",icon:p},{id:"data",title:"Данные",icon:m},{id:"performance",title:"Производительность",icon:u}];function C(){const[o,a]=n.useState(!1),i=async()=>{try{await navigator.clipboard.writeText(r),a(!0),setTimeout(()=>a(!1),2e3)}catch(t){console.error("Failed to copy:",t)}};return e.jsxs(e.Fragment,{children:[e.jsx("main",{className:"min-h-screen bg-background pt-24 pb-16",children:e.jsxs("div",{className:"max-w-5xl mx-auto px-4 md:px-8",children:[e.jsxs(s.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.5},className:"mb-12",children:[e.jsx("h1",{className:"text-3xl md:text-4xl font-semibold text-foreground mb-4",children:"Документация проекта"}),e.jsx("p",{className:"text-muted-foreground mb-6",children:"Полная техническая документация Neeklo Studio для работы с LLM (ChatGPT, Claude и др.)"}),e.jsx("div",{className:"flex flex-wrap gap-2 mb-8",children:h.map(t=>e.jsxs("div",{className:`flex items-center gap-2 px-3 py-1.5 rounded-full
                    bg-white/[0.03] border border-white/[0.06]
                    text-sm text-muted-foreground`,children:[e.jsx(t.icon,{className:"w-3.5 h-3.5 text-primary/60"}),t.title]},t.id))}),e.jsx(s.button,{onClick:i,whileHover:{scale:1.02},whileTap:{scale:.98},className:`flex items-center gap-3 px-6 py-3.5 rounded-2xl
                bg-gradient-to-r from-primary/20 via-primary/10 to-transparent
                border border-primary/30 hover:border-primary/50
                text-foreground font-medium
                transition-all duration-200
                hover:shadow-[0_0_30px_-5px_hsl(var(--primary)/0.3)]`,children:o?e.jsxs(e.Fragment,{children:[e.jsx(g,{className:"w-5 h-5 text-green-400"}),e.jsx("span",{className:"text-green-400",children:"Скопировано!"})]}):e.jsxs(e.Fragment,{children:[e.jsx(b,{className:"w-5 h-5"}),e.jsx("span",{children:"Скопировать всю документацию"})]})})]}),e.jsxs(s.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.5,delay:.1},className:"relative",children:[e.jsx("div",{className:"absolute inset-0 bg-gradient-to-b from-primary/[0.02] to-transparent rounded-3xl"}),e.jsx("div",{className:`relative p-6 md:p-8 rounded-3xl

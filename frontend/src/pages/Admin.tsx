...
import { Copy, Check, FileText, Code, Palette, Layers, Database, Zap } from "lucide-react";
import { Footer } from "@/components/layout/Footer";

const DOCUMENTATION = `# NEEKLO STUDIO — Полная документация проекта
...
const SECTIONS = [
  { id: "overview", title: "Обзор проекта", icon: FileText },
  { id: "design", title: "Дизайн-система", icon: Palette },
  { id: "structure", title: "Структура", icon: Layers },
  { id: "components", title: "Компоненты", icon: Code },
  { id: "data", title: "Данные", icon: Database },
  { id: "performance", title: "Производительность", icon: Zap },
];
        ...
        <div className="max-w-5xl mx-auto px-4 md:px-8">
          ...
          >
            ...
            <p className="text-muted-foreground mb-6">
              Полная техническая документация Neeklo Studio для работы с LLM (ChatGPT, Claude и др.)
            </p>
            ...
            >
              {copied ? (
                ...
                <>
                  ...
                  <span>Скопировать всю документацию</span>
                </>
              )}
            </motion.button>
          </motion.div>
          ...
          >
            ...
            >
              <pre className="whitespace-pre-wrap text-sm text-muted-foreground/80 font-mono leading-relaxed overflow-x-auto">
                {DOCUMENTATION}
              </pre>
            </div>
          </motion.div>
          ...
          >
            ...
            <ol className="space-y-3 text-muted-foreground text-sm">
              <li className="flex gap-3">
                ...
                <span>Нажмите кнопку "Скопировать всю документацию"</span>
              </li>
              <li className="flex gap-3">
                ...
                <span>Откройте ChatGPT или другой LLM</span>
              </li>
              <li className="flex gap-3">
                ...
                <span>Вставьте документацию в начало диалога с пометкой "Это документация проекта"</span>
              </li>
              <li className="flex gap-3">
                <span className="flex-shrink-0 w-6 h-6 rounded-full bg-primary/20 text-primary text-xs flex items-center justify-center font-medium">4</span>
                <span>Теперь LLM понимает структуру проекта и может писать точные промты</span>
              </li>
            </ol>
          </motion.div>
        </div>
